    ...
    <nav class="navbar navbar-expand-lg">
        <div class="container-fluid">
            <a class="navbar-brand" href="#">
                <img src="../../../assets/cinimate-logo.webp" alt="Cinemate" style="height: 40px;">
                <a class="nav-link fs-2 fw-bold" href="#">Cinimate</a>
            </a>
            <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarNav" aria-controls="navbarNav" aria-expanded="false" aria-label="Toggle navigation">
                <span class="navbar-toggler-icon "></span>
            </button>
            <div class="collapse navbar-collapse justify-content-center " id="navbarNav">
                <ul class="navbar-nav text-end me-2">
                    <li class="nav-item fs-5 fw-normal active">
                        <a class="nav-link" href="#">Home</a>
                    </li>
                    <li class="nav-item fs-5 fw-normal">
